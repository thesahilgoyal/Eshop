...
echo'       <table style="width:100%">
                <tr>
                    <td colspan="2">
                        ...
                        To know more, please kindly contact us at <a onClick="otpSupportOnClick();"><u> otpsupport@xecurify.com</u></a>.
                        <hr>
                    </td>
                </tr>
            ...
            <table>
            <tr>
            <td> <img class = "mo_support_form_new_feature mo_otp_new_feature_class" src="'.MOV_URL.'includes/images/mo_firebase.png"></td>
                ...
                <tr>
                    <td colspan="2">
                        <h2>'.mo_("FREQUENTLY ASKED QUESTIONS").'
                            <span style="float:right;margin-top:-10px;">
                                <span   class="dashicons dashicons-arrow-down toggle-div" 
                                        data-show="false" 
...
echo'                                       </div>
                            ...
                            <div class="mo_otp_note">
                                ...
                                <div id="wp_sms_integration" hidden >
                                    '.mo_( "If you wish to integrate the plugin with your form then please contact us at <a onclick= 'otpSupportOnClick();'><i>".$support."</i></a> or use the support form to send us a query.").'
                                </div>
                            </div>    
                            <div class="mo_otp_note">
