...
class MoOTPDocs
{   
    const CUSTOM_MESSAGES_ADDON_LINK  =   [
    ...
    const ULTIMATEMEMBER_PASSWORD_RESET_ADDON_LINK  =   [
        'guideLink' => 'https://plugins.miniorange.com/wordpress-otp-verification',
        'videoLink' => 'https://www.youtube.com/watch?v=atlyqTy8RHI&ab_channel=miniOrange'
    ];

     const ULTIMATEMEMBER_SMS_NOTIFICATION_LINK  =   [
        'guideLink' => 'https://plugins.miniorange.com/wordpress-otp-verification',
        'videoLink' => 'https://www.youtube.com/watch?v=atlyqTy8RHI&ab_channel=miniOrange'
    ];

     const WOCOMMERCE_SMS_NOTIFICATION_LINK  =   [
        'guideLink' => 'https://plugins.miniorange.com/wordpress-otp-verification',
        'videoLink' => 'https://www.youtube.com/watch?v=atlyqTy8RHI&ab_channel=miniOrange'
    ];
    const SELECTED_COUNTRY_CODE_ADDON_LINK  =   [
        'guideLink' => '',
        'videoLink' => ''
    ];

    const WOOCOMMERCE_PASSWORD_RESET_ADDON_LINK  =   [
        'guideLink' => '',
        'videoLink' => ''
    ];

    const WP_DEFAULT_FORM_LINK	=  	[
        'formLink'  => '',
    ...
    const UM_ENABLED 			=  	[
        ...
        'guideLink'	=> 'http://plugins.miniorange.com/otp-verification-ultimate-member-registration-form/',
    ...
    const BBP_FORM_LINK 		=  	[
        ...
        'guideLink'	=>'http://plugins.miniorange.com/configure-one-time-password-verification-buddypress-registration-form/',
        'videoLink'	=>'https://youtu.be/i5t7jV3H8IE'
    ];
    const CRF_FORM_ENABLE		=   [
    ...
    const UPME_FORM_LINK	    =   [
        'formLink'	=>'http://codecanyon.net/item/user-profiles-made-easy-wordpress-plugin/4109874',
    ...
    const NINJA_FORMS_LINK		=   [
        'formLink'	=>'https://ninjaforms.com/',
        'guideLink'	=> 'https://plugins.miniorange.com/otp-verification-for-ninja-forms',
        'videoLink'	=> ''
    ];
    const NINJA_FORMS_AJAX_LINK		=   [
        'formLink'	=>'https://ninjaforms.com/',
    ...
    const CALDERA_FORMS_LINK 	=   [
        'formLink'	=>'https://wordpress.org/plugins/caldera-forms/',
        'guideLink'	=>'http://plugins.miniorange.com/otp-verification-caldera-form/',
    ...
    const MULTISITE_REG_FORM = [
        'formLink'	=>'',
        'guideLink'	=>'',
        'videoLink'	=>''
    ];
    const WP_COMMENT_LINK = [
        'formLink'	=>'',
