...
use Instance;
    ...
    "WORDPRESS_PASSWORD_RESET" =>      [
      ...
      "VERIFICATION_VIA_LINK" =>      [
        'id'=>'VERIFICATION_VIA_LINK',
        'addonName'  => 'Verification via Email Link instead of One time Passcode',
        'addonDescription'  => 'Allows users to be verified via accept/rejects links receieved on the email instead of OTPs.<br>Click on the button below for further details.<br><br>',
        'addonPrice' => '$29*',
        'addonDetails' => 'This addon allows verification using accept/reject links instead of receieving one time passcodes on the email.<br>The user will receive a links on his/her email, which will verify the user based on if he/she chooses to accept or deny it.<br>Enabling just a checkbox will turn your user verification method to verification via link throughout the plugin.<br><br>'
    ],
     ...
     "SELECTED_COUNTRY" =>      [
       ...
       'addonPrice' => '$39*',
       'addonDetails' => 'In this Addon you can add a list of countries for which you wish to enable OTP Verirication. <br>The country code dropdown will be altered accordingly.<br><br>OTP Verification for any other country out of the selected list will be blocked by the addon.<br><br>'
   ],
       "RESEND_OTP_CONTROL" =>      [
